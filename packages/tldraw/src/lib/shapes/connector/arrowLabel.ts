...
import { getArrowLength } from './ConnectorShapeUtil'
import { TLArrowInfo } from './arrow-types'
import { getArrowInfo } from './shared'

const labelSizeCacheCache = new WeakCache<Editor, ComputedCache<Vec, ConnectorShape>>()

function getLabelSizeCache(editor: Editor) {
	return labelSizeCacheCache.get(editor, () => {
		return editor.store.createComputedCache<Vec, ConnectorShape>('arrowLabelSize', (shape) => {
...
function getArrowLabelSize(editor: Editor, shape: ConnectorShape) {
	if (shape.props.text.trim() === '') {
...
function getLabelToArrowPadding(shape: ConnectorShape) {
...
export function getArrowLabelPosition(editor: Editor, shape: ConnectorShape) {
	let labelCenter
...
export function getArrowLabelFontSize(shape: ConnectorShape) {
